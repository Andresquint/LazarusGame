...
public class Lazarus extends GameObject implements Observer {
    ...
    //Lazarus Spirit and object to create comical animations when he moves
    ...
    //different kind of collision event
    @Override
    ...
    public void draw(Graphics g, ImageObserver obs) {
        if (isDisplayed) {
            if (dead) {                
                ...
                g.drawString("\tYOU'RE HIStory! #Better luck next time", 200, 300);
                if (frame != 10) {
